...
public class ShowSingleRecordActivity extends AppCompatActivity {
    ...
    String HttpURL = "https://rawoolnar98.000webhostapp.com/Student/FilterStudentData.php";

    // Http URL for delete Already Open Student Record.
    String HttpUrlDeleteRecord = "https://rawoolnar98.000webhostapp.com/Student/DeleteStudent.php";
    ...
    TextView NAME,PHONE_NUMBER,CLASS,BYN;
    String NameHolder, NumberHolder, ClassHolder,BynHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PHONE_NUMBER = (TextView)findViewById(R.id.textPhone1);
        CLASS = (TextView)findViewById(R.id.textClass);
        BYN = (TextView)findViewById(R.id.new1);
        ...
        UpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ShowSingleRecordActivity.this,Mynote.class);
                ...
                if(FinalJSonObject != null)
                {
                    ...
                    try {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                            ...
                            NumberHolder = jsonObject.getString("sub").toString() ;
                            ClassHolder = jsonObject.getString("phone_number").toString() ;
                            BynHolder = jsonObject.getString("byn").toString() ;
